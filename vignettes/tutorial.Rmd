...
```
Introduction: This is a R package that includes four functions --- linear regression, T teest, randomforest cross-validation and k nearesr neighbors corss-validation.
Now, here's the instructions for how to install this package from Github
...
```
For the first t-test, we observe P = 0.09322877. Therefore there's evidence from data supporting that the true mean life expectancy is not equal to 60.

For the second t-test, we observe P = 0.9533856 Therefore cannot conclude that the true mean life expectancy is smaller than 60.

For the third t-test, we observe P = 0.04661438. Therefore Therefore there's evidence from data supporting that the true mean life expectancy is greater than 60.
